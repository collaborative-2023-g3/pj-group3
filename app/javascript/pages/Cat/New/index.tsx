    ...
    return (
        ...
        <ContainerTemplate>
            ...
            <PageTemplate>
                ...
                <p className="p-cats-create__description">下記の情報を入力して、「登録する」ボタンを押してください。</p>
                <FormTemplate onSubmit={handleSubmit(onSubmit)}>
                    <div className="t-form__input p-cats-create__form--label-with-validation-message">
                    ...
                    <div className="t-form__input p-cats-create__form--user-type">
                    ...
                    <div className="t-form__input p-cats-create__form--label-with-validation-message">
                        <label htmlFor="image-file" className="p-cats-create__form--profile-file-label">
                            ファイルを選択する
                    ...
                    <div className="p-cats-create__form--image-preview">
                        {profileImage && <img src={profileImage} alt="プロフィール写真" />}
                    </div>


                    {/* <div className="p-cats-create__form--label-with-validation-message">
                        <label htmlFor="status">募集ステータス</label>
                        {errors.status?.message && <span>{errors.status.message}</span>}
                    </div>
                    <div className="p-cats-create__form--user-type">
